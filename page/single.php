        ...
        <div class="row">
            <div class="post-page">
                ...
                <div class="content-post">
                    <h5>نكاتی برای فریلنسر شدن</h5>
                    <br>
                    <p>در این دوره با توجه به این که تمامی دانش آموختگان عزیز بعد از فراگیری کد ها و قوانین ایجاد صفحات استاتیک سایت آشنا شده اند، طبیعتا الزام است در قالب پروژه های واقعی با کد ها دست و پنجه نرم کنند و بدانند در چه زمانی الزام است چه کدی را قرار دهند. در سری دوره های وب دیزاینر از ساده ترین پروژه ها تا سخت ترین پروژه های طراحی وب را انجام خواهیم داد. در انتهای این دوره نیز یک پروژه تمرینی به شما واگذار خواهد شد که باید با توجه به دانشی که در طی دوره کسب کرده اید آن را طراحی کنید. همینطور شما از طریق پرسش و پاسخ دوره با بنده در ارتباط هستید و اگر در طراحی قالب تمرینی با چالشی مواجه شدید به کمک یکدیگر آن را حل خواهیم کرد. </p>
                    <p>در این دوره با توجه به این که تمامی دانش آموختگان عزیز بعد از فراگیری کد ها و قوانین ایجاد صفحات استاتیک سایت آشنا شده اند، طبیعتا الزام است در قالب پروژه های واقعی با کد ها دست و پنجه نرم کنند و بدانند در چه زمانی الزام است چه کدی را قرار دهند. در سری دوره های وب دیزاینر از ساده ترین پروژه ها تا سخت ترین پروژه های طراحی وب را انجام خواهیم داد. در انتهای این دوره نیز یک پروژه تمرینی به شما واگذار خواهد شد که باید با توجه به دانشی که در طی دوره کسب کرده اید آن را طراحی کنید. همینطور شما از طریق پرسش و پاسخ دوره با بنده در ارتباط هستید و اگر در طراحی قالب تمرینی با چالشی مواجه شدید به کمک یکدیگر آن را حل خواهیم کرد.</p>
                    <p>در این دوره با توجه به این که تمامی دانش آموختگان عزیز بعد از فراگیری کد ها و قوانین ایجاد صفحات استاتیک سایت آشنا شده اند، طبیعتا الزام است در قالب پروژه های واقعی با کد ها دست و پنجه نرم کنند و بدانند در چه زمانی الزام است چه کدی را قرار دهند. در سری دوره های وب دیزاینر از ساده ترین پروژه ها تا سخت ترین پروژه های طراحی وب را انجام خواهیم داد. در انتهای این دوره نیز یک پروژه تمرینی به شما واگذار خواهد شد که باید با توجه به دانشی که در طی دوره کسب کرده اید آن را طراحی کنید. همینطور شما از طریق پرسش و پاسخ دوره با بنده در ارتباط هستید و اگر در طراحی قالب تمرینی با چالشی مواجه شدید به کمک یکدیگر آن را حل خواهیم کرد.</p>
                ...
                <div class="tag-post">
                    ...
                    <span>وبلاگ موزش برنامه نویسی</span>
                    <span>فریلنسر</span>
                    <span>برنامه نویس</span>
                    <span>وبلاگ موزش برنامه نویسی</span>
                    <span>فریلنسر</span>
